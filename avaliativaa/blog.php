        ...
        <div class="row">
            ...
            <div class="col-md-9 py-3">
                ...
                <?php foreach ($artigos as $v) { ?>
                    <div class="card mb-3">
                        <div class="card-body">
                            <h5 class="card-title"><?php echo $v['id_artigo']; ?></h5>
                            <h6 class="card-subtitle mb-2 text-muted"><?php echo $v['titulo']; ?></h6>
                            <p class="card-text"><?php echo $v['nome_autor']; ?></p>
                            <a href="ler.php?id=1"><?php echo $v['corpo_artigo']; ?></a>
                        </div>
                    </div>
                <?php } ?>
